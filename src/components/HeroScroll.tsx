    ...
    <div ref={containerRef} className="h-[250vh] bg-[#0a0e14] text-white relative z-0">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 -z-15 pointer-events-none overflow-hidden">
          <motion.div
            className="absolute top-[-15%] left-[-15%] w-[60vw] h-[60vh] bg-[#00eaff]/[0.06] rounded-full blur-[140px]"
        ...
        <motion.div style={{ opacity: hudOpacity }} className="absolute inset-0 pointer-events-none overflow-hidden">
          {/* Top-left telemetry */}
          <div className="absolute top-20 left-6 md:left-10 font-mono text-[10px] text-[#00eaff]/60 uppercase tracking-widest leading-loose">
          ...
          <div className="absolute top-20 right-6 md:right-10 text-right font-mono text-[10px] uppercase tracking-widest leading-loose">
            ...
            <div className="flex items-center gap-1.5 justify-end">
              <div className="w-1.5 h-1.5 rounded-full bg-[#00eaff] animate-pulse shadow-[0_0_4px_#00eaff]" />
              <span className="text-[#00eaff]/70">Active</span>
            </div>
          </div>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 pointer-events-none">
            <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-[#00eaff]/30" />
            <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-[#00eaff]/30" />
            <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-[#00eaff]/30" />
            <div className="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-[#00eaff]/30" />
          </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none p-10">
          ...
          >
            ...
            <motion.p
              ...
              className="font-mono text-[#00eaff] text-sm md:text-lg tracking-[0.3em] uppercase font-medium" style={{ textShadow: '0 2px 12px rgba(0,0,0,0.9)' }}
            >
          ...
          >
            <div className="p-6">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-1.5 h-1.5 rounded-full bg-[#00eaff] shadow-[0_0_6px_#00eaff]" />
                <span className="font-mono text-[11px] text-[#00eaff]/80 uppercase tracking-[0.2em]">System Architecture</span>
              </div>
              ...
              <div className="w-10 h-0.5 bg-gradient-to-r from-[#00eaff] to-transparent" />
            </div>
          </motion.div>
          ...
          >
            <div className="p-6 text-right">
              <div className="flex items-center gap-2 justify-end mb-3">
                <span className="font-mono text-[11px] text-[#00eaff]/80 uppercase tracking-[0.2em]">Sensor Fusion</span>
                <div className="w-1.5 h-1.5 rounded-full bg-[#00eaff] shadow-[0_0_6px_#00eaff]" />
              </div>
              <h2 className="font-sans text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.7)' }}>
                Layered Intelligence
              </h2>
              <div className="w-10 h-0.5 bg-gradient-to-l from-[#00eaff] to-transparent ml-auto" />
            </div>
          </motion.div>
          ...
          >
            <div className="p-6">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-1.5 h-1.5 rounded-full bg-[#00eaff] shadow-[0_0_6px_#00eaff]" />
                <span className="font-mono text-[11px] text-[#00eaff]/80 uppercase tracking-[0.2em]">Field Operations</span>
              </div>
              <h2 className="font-sans text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.7)' }}>
          ...
          >
            ...
            <Link
              href="/demo"
              className="px-10 py-4 rounded-xl bg-[#00eaff] text-[#0a0e14] text-base font-mono font-bold uppercase tracking-[0.15em] hover:scale-105 hover:shadow-[0_0_40px_rgba(0,238,252,0.4)] transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] inline-block"
            >
              Explore System
            </Link>
          </motion.div>
          ...
          >
            ...
            <div className="w-5 h-8 rounded-full border border-[#00eaff]/30 flex items-start justify-center p-1">
              <motion.div
